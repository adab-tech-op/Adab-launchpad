...
export default function SignUpPage() {
  ...
  if (done) {
    return (
      <AuthShell
        ...
        subtitle={`We've sent a verification link to ${email}. Confirm it to activate your account, then sign in.`}
        footer={
  ...
  return (
    <AuthShell
      ...
      subtitle="Optional — you can reserve as a guest. An account lets you track orders and save a wishlist."
      footer={
        <>
